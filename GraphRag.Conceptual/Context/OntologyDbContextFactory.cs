...
{
    internal class OntologyDbContextFactory : IDesignTimeDbContextFactory<OntologyDbContext>
    {
        public OntologyDbContext CreateDbContext(string[] args)
        {
            ...
            var configuration = new ConfigurationBuilder()
                ...
                .AddUserSecrets<OntologyDbContext>(optional: true)
            ...
            return new OntologyDbContext(options);
        }
    }
}
